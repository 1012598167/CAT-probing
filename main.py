...
with open('./xxx.txt', 'w',encoding='utf-8') as f:
    f.write('\t'+yyy.strip().encode('utf8').decode()+'\n')
    print("write \u5e74 success")
#sys.stdout = codecs.getwriter("utf-8")(sys.stdout.detach())

#already sys.stdout = codecs.getwriter("utf-8")(sys.stdout.detach())
...
#                                           target_ids=target_ids, target_mask=target_mask)
                ...
                ###distance
                loss += 0####mofang zhao attention guocheng 
